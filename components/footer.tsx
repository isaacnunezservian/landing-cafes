        ...
        <div className="flex flex-col md:flex-row items-center gap-10 md:gap-14">
          ...
          <div className="flex-1 text-center md:text-left">
            ...
            <p className="text-base text-espresso-600 leading-relaxed mb-6 max-w-lg">
              Hola, soy Rafael! Podés visitar mi LinkedIn o directamente escribirme por WhatsApp. Va a ser un gustazo ayudarte!
            </p>
            <div className="flex flex-col sm:flex-row gap-3 justify-center md:justify-start">
              ...
              <a
                href="https://wa.me/5491170061908?text=Hola%20Rafael%2C%20quiero%20saber%20m%C3%A1s%20sobre%20Cafex"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2.5 bg-[#25D366] hover:bg-[#1FAD54] text-white font-medium text-sm px-5 py-3 rounded-xl transition-colors shadow-md shadow-[#25D366]/20"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
